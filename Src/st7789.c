...
void ST7789_SetRotation(uint8_t m)
{
	...
	case 0:
		...
		ST7789_WriteCommand(0x4A);
		ST7789_WriteSmallData(ST7789_MADCTL_RGB | 0x20 | 0x01 );
		//ST7789_WriteCommand(ST7789_MADCTL);	// MADCTL
		//ST7789_WriteCommand(0x08);
...
void ST7789_Init(void)
{
	...
	ST7789_SetRotation;	//	MADCTL (Display Rotation)
	...
	ST7789_WriteCommand (ST7789_SLPOUT);	//	Out of sleep mode
  	...
  	ST7789_WriteCommand (ST7789_MADCTL_RGB);
